...
export const createBooking = async (req, res) => {
    try {
        ...
        if(existingBooking){
            return res.status(400).json({message:"You already have a booking at this date and time", success:false})
        }
       ...
       await booking.save();
        return res.json({message:"Booking created successfully", success:true, booking});
